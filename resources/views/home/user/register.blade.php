...
<head>
    ...
    <link rel="stylesheet" href="{{asset('home')}}/Content/base.css" type="text/css" />
    <link rel="stylesheet" href="{{asset('home')}}/Content/common-less.css" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        var OP_CONFIG={"module":"user","page":"newsignup","userInfo":{"uid":"4651600","nickname":"qq_echo_47","head":"http:\/\/img.mukewang.com\/user\/585e910d0001aec101000100-80-80.jpg","usertype":"1","roleid":0}};
        var isLogin = 1;
        var is_choice = "";
    ...
    <link rel="stylesheet" href="{{asset('home')}}/Content/loginsign-less.css" />
    <script>
        var fromURL='';
    </script>
        ...
        <div class="wrap clearfix">
            <div class="wrap-left">
                <div class="login-wrap">
                    ...
                    <span class="ipadHide">
                        <a href="/user/newlogin/from_url/" class="on-register r">直接登录</a>
...
<script type="text/javascript">
    seajs.use("/static/page/user/newsignup.js");
</script>
