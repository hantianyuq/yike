...
<head>
    ...
    <meta name="Description" content="易课网推出的PS入门教程，PS入门学习必备课程，本课程将带你从PS的基本界面开始熟悉，ps入门课程主要分为三个章节，ps基本工具，ps选择与变形，ps色彩调整，通过小案例来学习简单的工具，终极目标就是先揭开PS的面纱，让你掌握PS的基本用法。"/>
    ...
    <script type="text/javascript">
        ...
        var OP_CONFIG={"module":"course","page":"comment","userInfo":{"uid":4911548}};
        var isLogin = 1;
        var is_choice = "";
    ...
    <link rel="stylesheet" href="{{asset('home')}}/Content/6a4eb1ca6a144613a2361dbf60d3e51b.css" type="text/css" />
</head>
<body >

<div id="header">
    <div class="page-container" id="nav">
        <div id="logo" class="logo"><a href="/" target="_self" class="hide-text" title="首页">易课网</a></div>
        ...
        <ul class="nav-item">
            ...
            <li>
                <a href="{{asset('home')}}/course/list"  target="_self">课程</a>
            </li>
            <li><a href="{{asset('home')}}/course/program" class="program-nav " target="_self">职业路径<i class="icn-new"></i></a></li>
            <li>
...
<div id="main">
    ...
    <div class="course-infos">
        <div class="w pr">
            <div class="path">
                <a href="{{asset('home')}}/course/list">课程</a>
                @foreach($bread as $val)
                <i class="path-split">\</i><a href="{{asset('home/section/lists').$val['a']}}">{{$val['name']}}</a>
                @endforeach
                <i class="path-split">\</i><a href="#"><span>{{$course['course_name']}}</a></span>
            </div>
            ...
            <div class="statics clearfix">
                ...
                <div class="static-item l">
                    ...
                    <span class="meta-value js-learn-num">{{$course['learn_num']}}</span>
                </div>
                <div class="static-item l">
                    <span class="meta">难度级别</span>
                    <span class="meta-value">{{$course['course_rank']}}</span>
                    <em></em>
                </div>
                <div class="static-item l">
                ...
                <div class="static-item l score-btn">
                    ...
                    <div class="score-wrap icon-drop_up triangle">
                        <div class="score-box">
                            <a href="{{asset('home')}}/coursescore/139" class="person-num">
                                <span class="person-num l">342人评价</span>
                            </a>
                            <a href="{{asset('home')}}/coursescore/139?page=1" class="evaluation-btn r">查看评价</a>
        ...
        <div class="content-wrap clearfix">
            <div class="content">
                ...
                <div class="course-brief">
                    <p class="auto-wrap">简介：{{$course['course_intro']}}</p>
                </div>
                <!-- 课程简介 end -->
                ...
                <div id="course_note">
                    <ul class="mod-post" id="comment-list">
                        @foreach($review as $val)
                            <li class="post-row" id="24435">
                                <div class="media">
                                    <a href="/u/1180969{{asset('home')}}/courses" target="_blank"><img src="{{asset('home')}}/Picture/54584f0b000124f802200220-40-40.jpg" width="40" height="40"></a>
                                </div>
                                <div class="bd">
                                    <div class="tit">
                                        <a href="/u/1180969{{asset('home')}}/courses" target="_blank">{{$val['user_name']}}</a>
                                    </div>
                                    <p class="cnt">{{$val['review_content']}}</p>
                                    <div class="footer clearfix">
                                        <span title="创建时间" class="l timeago">时间：{{$val['time']}}</span>
                                        <a href="{{url('home/section/show')}}?chapter_id={{$val['chapter_id']}}" class="from">{{$val['chapter_name']}}</a>
                                        <div class="actions r">
                                            <a title="赞" href="javascript:;">
                                                @if($val['praise_people'] == 1)
                                                    <span class="praise_cancel" rid="{{$val['review_id']}}" status="1">取消赞</span>
                                                @else
                                                    <span class="praise" rid="{{$val['review_id']}}">赞</span>
                                                @endif
                    ...
                    <div class="page">{{$review->appends(["course_id"=>$course_id])->links()}}</div>
                </div>
                ...
                <div class="bd">
                    ...
                    <div class="box mb40 js-usercard-box">
                        ...
                        <div class="teacher-info">
                            <a href="/u/141256{{asset('home')}}/courses?sort=publish" target="_blank" >
                            ...
                            <span class="tit">
                <a href="/u/141256{{asset('home')}}/courses?sort=publish" target="_blank">Oeasy</a><i class="icon-imooc"></i>
            </span>
...
<script>
    $(function(){
        ...
        $(document).on('click','.praise',function(){
                ...
                var obj = $(this);
                var num = $(this).parent().siblings('em').html();
                num++;
                $.ajax({
                    type: "GET",
                    url: "{{url('home/Comment/praise')}}",
                    data: {
                        rid:rid,
                    },
        ...
        $(document).on('click','.praise_cancel',function(){
            var rid = $(this).attr('rid');
            var obj = $(this);
            var num = $(this).parent().siblings('em').html();
            num--;
            $.ajax({
                type: "GET",
                url: "{{url('home/Comment/praiseCancel')}}",
                data: {
                    rid:rid,
                },
                success: function(msg){
...
<script type="text/javascript" charset="utf-8" src="Scripts/ueditor.final.min.js"></script>

<!--script-->
<script src="Scripts/ssologin.js"></script>
<script type="text/javascript" src="Scripts/sea.js"></script>
<script type="text/javascript" src="Scripts/sea_config.js"></script>
...
<script type="text/imooc-tpl" id="tpl_pl">
    <li class="post-row">
        <div class="media">
            <a href="/u/{uid}{{asset('home')}}/courses" target="_blank">
                <img src="{{asset('home')}}/Picture/7f25a56ad9824ee598c4521c669fec41.gif" width="40" height="40">
            </a>
        </div>
        <div class="bd">
            <div class="tit">
                <a href="/u/{uid}{{asset('home')}}/courses" target="_blank">{nickname}</a>
            </div>
            <p class="cnt">{txt}</p>
            <div class="footer clearfix">
