            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover ">
                        ...
                        <tr class="gradeX">
                            <td>{{$v['section_id']}}</td>
                            <td name="name" sid="{{$v['section_id']}}"><span class="update">{{$v['name']}}</span>
                            </td>
                            <td class="center" name="intro" sid="{{$v['section_id']}}"><span class="update">{{$v['intro']}}</span></td>
                            <td class="center del" sid="{{$v['section_id']}}">删除</td>
                        </tr>
                        @endforeach
                        </tfoot>
                    </table>
