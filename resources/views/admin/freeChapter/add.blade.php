            ...
            <div class="col-sm-6">
                <div class="row float-e-margins" style="width: 800px;margin-left: 100px;margin-top: 100px;height: 800px">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" action="{{url('admin/chapter/adddo')}}" method="post">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label class="col-sm-3 control-label">章节名：</label>

                                <div class="col-sm-8">
                                    <input type="text" placeholder="章节名" class="form-control" name="name">
                                    <span class="help-block m-b-none">请输入要填入的章节名称</span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="course" >
                                        ...
                                        <option value="{{$v['section_id']}}">{{$v['name']}}</option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">章节链接</label>

                                <div class="col-sm-8">
                                    <input type="text" placeholder="章节链接" class="form-control" name="all">
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-8">
                                    <input class="btn btn-sm btn-info" type="submit" value="添加小章节"/>
                                </div>
                        </form>
                    </div>
                </div>
